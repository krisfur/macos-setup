...
```bash
brew install anomalyco/tap/opencode claude-code cmake codex discord fastfetch gh ghostty go helium-browser krisfur/tap/fex localsend mpv neovim neovim ninja node obs odin steam t3-code tree-sitter-cli typst uv whatsapp zed zig
```
