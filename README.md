...
```bash
brew install claude-code cmake discord fastfetch gh ghostty go helium-browser jq krisfur/tap/fex localsend neovim neovim ninja node obs odin pnpm ripgrep tree-sitter-cli typst uv vlc vscodium whatsapp zig zls
```
